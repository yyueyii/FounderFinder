...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/_sitemap` | `/chat` | `/chat-room` | `/edit-profile` | `/home` | `/hooks/useGetConversation` | `/hooks/useGetMessages` | `/hooks/useSendMessages` | `/log-in` | `/matches` | `/profile` | `/sign-up` | `/store/useConversation` | `/store/userStore` | `/successful-match` | `/view-profile`;
