...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/_sitemap` | `/chat` | `/chat-room` | `/edit-profile` | `/home` | `/loading` | `/log-in` | `/matches` | `/profile` | `/sign-up` | `/store/userStore` | `/successful-match` | `/view-profile`;
