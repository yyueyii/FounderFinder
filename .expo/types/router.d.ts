...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/chat` | `/chat-room` | `/edit-profile` | `/home` | `/hooks/useGetConversation` | `/hooks/useGetMessages` | `/hooks/useSendMessages` | `/log-in` | `/matches` | `/profile` | `/sign-up` | `/store/chatStore` | `/store/notificationStore` | `/store/useConversation` | `/store/userStore` | `/successful-match` | `/view-profile`;
